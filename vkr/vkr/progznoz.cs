...
namespace vkr
{
    public partial class progznoz : Form
    {
        ...
        private void method ()
        {
            ...
            if (dataGridView2.Rows[n - 1].Cells[0].Value.ToString() != "12") dataGridView2.Rows[n].Cells[0].Value = Convert.ToInt32(dataGridView2.Rows[n - 1].Cells[0].Value) + 1;
            else dataGridView2.Rows[n].Cells[0].Value = 0;
            dataGridView2.Columns.Add("column2","Cреднее");
            
            if (dataGridView2.Rows.Count <13)
            {
                int i = 2;
            ...
            if (dataGridView2.Rows.Count - 1 ==12)
            {
                ...
                for (int i = 0; i < dataGridView2.Rows.Count - 1; i++)
                    {
                        dataGridView2.Rows[i].Cells[3].Value = Convert.ToDouble(dataGridView2.Rows[i].Cells[1].Value) / summ * 12;
                    }
